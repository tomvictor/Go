...
type Person_PhoneNumber struct {
	...
	Type   Person_PhoneType `protobuf:"varint,2,opt,name=type,proto3,enum=user.Person_PhoneType" json:"type,omitempty"`
}
...
var file_user_proto_rawDesc = []byte{
	...
	0x65, 0x73, 0x18, 0x04, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x18, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	...
	0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e, 0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x2e, 0x50, 0x68, 0x6f,
	...
	0x6c, 0x65, 0x18, 0x01, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x0c, 0x2e, 0x75, 0x73, 0x65, 0x72, 0x2e,
	0x50, 0x65, 0x72, 0x73, 0x6f, 0x6e, 0x52, 0x06, 0x70, 0x65, 0x6f, 0x70, 0x6c, 0x65, 0x42, 0x26,
	0x5a, 0x24, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x74, 0x6f, 0x6d,
	0x76, 0x69, 0x63, 0x74, 0x6f, 0x72, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x62, 0x75, 0x66, 0x2f,
...
var file_user_proto_goTypes = []interface{}{
	(Person_PhoneType)(0),         // 0: user.Person.PhoneType
	(*Person)(nil),                // 1: user.Person
	(*AddressBook)(nil),           // 2: user.AddressBook
	(*Person_PhoneNumber)(nil),    // 3: user.Person.PhoneNumber
	(*timestamppb.Timestamp)(nil), // 4: google.protobuf.Timestamp
}
var file_user_proto_depIdxs = []int32{
	3, // 0: user.Person.phones:type_name -> user.Person.PhoneNumber
	4, // 1: user.Person.last_updated:type_name -> google.protobuf.Timestamp
	1, // 2: user.AddressBook.people:type_name -> user.Person
	0, // 3: user.Person.PhoneNumber.type:type_name -> user.Person.PhoneType
